...
* UI: Added more control over caching with per cache category environment variables, as [documented in the User Manual.](https://nuitka.net/doc/user-manual.html#control-where-caches-live).
...
* UI: Proper error message from Nuitka when scons build fails with a detail mnemonic page. Read more on [the info page](https://nuitka.net/info/scons-backend-failure.html) for detailed information.
